...
def matmul_add(
    ...
    def main(
        ...
        with T.Kernel(m_num * n_num, is_npu=True) as (cid, vid):
            ...
            for k in T.Pipelined(loop_k, num_stages=3, cross_interval=cross_interval):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cross_interval", type=int, default=2, help="Cross interval for sync condition")
    ...
    func = matmul_add(M, N, K, 128, 256, 64, cross_interval=args.cross_interval)
