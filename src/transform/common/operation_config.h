...
GetOperationConfig() {
  static std::unordered_map<std::string, OperationConfig> operation_config_ = {
      ...
      {"AscendC::Axpy", {{{0, "read"}, {0, "write"}, {1, "read"}}, "PIPE_V"}},
      ...
      {"AscendC::Sin", {{{0, "write"}, {1, "read"}, {2, "write"}}, "PIPE_V"}},
      {"AscendC::Cos", {{{0, "write"}, {1, "read"}, {2, "write"}}, "PIPE_V"}},
      ...
      {"AscendC::ShiftRight",
       {{{0, "write"}, {1, "read"}, {2, "read"}}, "PIPE_V"}},
      {"AscendC::Sort", {{{1, "read"}, {1, "write"}, {2, "read"}, {2, "write"}, {3, "read"}, {3, "write"}}, "PIPE_V"}},
      ...
      {"tl.ascend_mma",
       {{{1, "read"}, {2, "read"}, {3, "read"}, {3, "write"}}, "PIPE_M"}},
      {"tl.ascend_gemm_v0",
       {{{1, "read"}, {2, "read"}, {3, "read"}, {3, "write"}}, "PIPE_M"}},
      {"tl.ascend_gemm_v1",
       {{{1, "read"}, {2, "read"}, {3, "read"}, {3, "write"}}, "PIPE_M"}},
      ...
      {"tl.ascend_axpy", {{{0, "read"}, {0, "write"}, {1, "read"}}, "PIPE_V"}},
      ...
      {"tl.ascend_sin", {{{0, "write"}, {1, "read"}, {2, "write"}}, "PIPE_V"}},
      {"tl.ascend_cos", {{{0, "write"}, {1, "read"}, {2, "write"}}, "PIPE_V"}},
      ...
      {"tl.ascend_pow",
       {{{0, "write"}, {1, "read"}, {2, "read"}, {3, "write"}}, "PIPE_V"}},
      ...
      {"tl.ascend_sort",
       {{{1, "read"}, {1, "write"}, {2, "read"}, {2, "write"}, {3, "read"}, {3, "write"}}, "PIPE_V"}},
